                    ...
                    foreach (var item in GateWay.GateWaySenserIDs)
                    {
                        ...
                        switch (senserEnumType)
                        {
                            case SenserEnumType.WeatherAPI:
                                {
                                    WeatherUserControl = new WeatherUserControl(GateWay, Taiwan_DistricsSetting, item, AbsProtocols,GIA_DistricsSetting) { Dock = DockStyle.Fill, Parent = WeatherpanelControl };
